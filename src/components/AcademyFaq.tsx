...
const AcademyFaq = () => (
  <section id="faq" className="bg-background py-16 md:py-24">
    <div className="container mx-auto grid gap-10 px-5 md:grid-cols-[0.7fr_1.3fr]">
      <div><p className="mb-3 text-xs font-bold uppercase text-primary">Common questions</p><h2 className="text-3xl font-bold md:text-4xl">Choose with confidence.</h2></div>
